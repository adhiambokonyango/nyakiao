...
router.post('/add_GGGGrParents', urlencodedParser,function(request,response){
...
router.post('/get_all_GGGGrParents',urlencodedParser,function(request,response){
...
router.post('/get_specific_GGGGrParents',urlencodedParser,function(request,response){
...
router.post('/update_GGGGrParents',urlencodedParser,function(request,response){
...
router.post('/update_individual_GGGGrParents',urlencodedParser,function(request,response){
...
router.post('/delete_individual_GGGGrParents',urlencodedParser,function(request,response){
...
router.post('/get_number_of_GGGGrParents_records',urlencodedParser,function(request,response){
...
router.post('/GGGGrParents_user_specific_query',urlencodedParser,function(request,response){
