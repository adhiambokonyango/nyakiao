...
This class is the GGGrParents table's route class.
It is initialized at the "Index.js" and is able to recieve
calls from the client and passes the calls down to the
"GGGrParentsController" class
*/
...
const GGGrParentsController = require('../../controllers/great_grand_parents/GGGrParentsController.js');
...
router.post('/add_gggr_parents', urlencodedParser,function(request,response){
    ...
    var myPromise = GGGrParentsController.insert(jsonObject_);
...
router.post('/get_specific_gggr_parents',urlencodedParser,function(request,response){
    ...
    var myPromise = GGGrParentsController.get_specific_records(mKey,mValue);
...
router.post('/update_gggr_parents',urlencodedParser,function(request,response){
    ...
    var myPromise = GGGrParentsController.batch_update(jsonObject_);
...
router.post('/update_individual_gggr_parents',urlencodedParser,function(request,response){
    ...
    var myPromise = GGGrParentsController.individual_record_update(column_name,value_,jsonObject_);
...
router.post('/delete_individual_gggr_parents',urlencodedParser,function(request,response){
    ...
    var myPromise = GGGrParentsController.delete_user_specic_record(column_name,value_,UserIdColumnName,UserId);
...
router.post('/get_number_of_gggr_parents_records',urlencodedParser,function(request,response){
    ...
    var myPromise = GGGrParentsController.get_number_of_records(column_name,value_);
...
router.post('/gggr_parents_user_specific_query',urlencodedParser,function(request,response){
    ...
    var myPromise = GGGrParentsController.user_specific_select_query(ColumnName,value_,UserIdColumnName,UserId);
